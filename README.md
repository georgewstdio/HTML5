...
There are no prerequisites as such for current courses/lessons. It's an added advantage if you know basic concepts like Web, Internet, web page, URL, images, etc.
...
### 1.1. Welcome
Hi Everyone, I'm **`George`** I work in webstudio team, I wanna welcome you for today's HTML5 Session. This Session will take an in-depth look at HTML/HTML5, will learn Syntax and Semantics of HTML. Will also focus on best practices to implement while showing you and writing HTML5 hands-on. 

So, Here will start by learning what is HTML, Basic HTML Document/Page structure, How to write and format page content, creating a list, link, table, and many more things.
